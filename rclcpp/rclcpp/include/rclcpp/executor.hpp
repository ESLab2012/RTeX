...
protected:
  ...
  bool
  RTeX_get_next_ready_executable(AnyExecutable & any_executable);

  bool
  RTeX_get_next_ready_executable_from_map(
  AnyExecutable & any_executable,
  const rclcpp::memory_strategy::MemoryStrategy::WeakCallbackGroupsToNodesMap &
  weak_groups_to_nodes);

  bool
  RTeX_get_next_executable(AnyExecutable & any_executable, std::chrono::nanoseconds timeout);
  ...
  bool
  RTeX_execute_any_executable(AnyExecutable & any_executable);
