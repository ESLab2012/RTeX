...
public:
  ...
  virtual bool collect_entities_lf(const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) = 0;
  ...
  virtual size_t timer_handles_num() const = 0;
  virtual size_t waitable_handles_num() const = 0;
  ...
  virtual bool add_handles_to_wait_set_lf(rcl_wait_set_t * wait_set) = 0;
  virtual void clear_handles() = 0;
  virtual void clear_handles_timers() = 0;
  virtual void remove_null_handles(rcl_wait_set_t * wait_set) = 0;
  virtual void remove_null_handles_lf(rcl_wait_set_t * wait_set) = 0;
